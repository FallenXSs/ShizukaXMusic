...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/FallenXSs/ShizukaXMusic")
GIT_TOKEN = getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/MajesteSupport")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/MajesteSohbet")
